...
const LandingPage: React.FC = () => {
  ...
  const mailicon = isLightMode ? mailiconl : mailicond;
  const githubicon = isLightMode ? githubiconl : githubicond;
  const linkedinicon = isLightMode ? linkediniconl : linkedinicond;
      ...
      <div className="landingpage-sidebar">
        <div className="landingpage-sidebar-items">
          {isLightMode ? (
            ...
            <div className="line1-dark"></div>
          )}
          <div className="sidebar-icons">
            <a href="mailto:kumararyanaim@gmail.com">
        ...
        <div
          className={
            isLightMode
              ...
              : "landingpage-main-text dark-font"
          }
        >
